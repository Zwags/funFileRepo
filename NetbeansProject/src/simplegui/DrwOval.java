 ...
 * @author rolf
 */
public class DrwOval extends AbstractDrawable {
    private int width, height;
    private boolean filled;
    private BasicStroke stroke;

    public DrwOval(Color c, double transparency, double posX, double posY, double width, double height, int strokeWidth, String name, boolean filled) {
